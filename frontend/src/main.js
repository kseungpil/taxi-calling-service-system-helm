...
pluralCaseList.push( {plural: "callingServiceContexts/taxiRequests", pascal: "CallingServiceContextTaxiRequest"} )
pluralCaseList.push( {plural: "callingServiceContexts/taxiAssignments", pascal: "CallingServiceContextTaxiAssignment"} )
pluralCaseList.push( {plural: "callingServiceContexts/taxiTrips", pascal: "CallingServiceContextTaxiTrip"} )
pluralCaseList.push( {plural: "callingServiceContexts/tripRecords", pascal: "CallingServiceContextTripRecord"} )

pluralCaseList.push( {plural: "driverServiceContexts/drivers", pascal: "DriverServiceContextDriver"} )

pluralCaseList.push( {plural: "customerServiceContexts/customers", pascal: "CustomerServiceContextCustomer"} )
