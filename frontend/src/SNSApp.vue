            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="taxiRequests"
                        to="/callingServiceContexts/taxiRequests"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="taxiAssignments"
                        to="/callingServiceContexts/taxiAssignments"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="taxiTrips"
                        to="/callingServiceContexts/taxiTrips"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="tripRecords"
                        to="/callingServiceContexts/tripRecords"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="drivers"
                        to="/driverServiceContexts/drivers"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="customers"
                        to="/customerServiceContexts/customers"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '택시 호출 요청', 
                description: '고객이 택시를 호출하는 요청', 
                key: 'taxiRequests', 
                route: '/callingServiceContexts/taxiRequests',
                ImageUrl: '',
            },
            { 
                title: '택시 할당 요청', 
                description: '운전자가 할당된 택시를 수락 또는 거부', 
                key: 'taxiAssignments', 
                route: '/callingServiceContexts/taxiAssignments',
                ImageUrl: '',
            },
            { 
                title: '택시 운행', 
                description: '운전자가 택시 운행 및 종료', 
                key: 'taxiTrips', 
                route: '/callingServiceContexts/taxiTrips',
                ImageUrl: '',
            },
            { 
                title: '운행 정보', 
                description: '고객이 택시 운행 정보와 요금을 조회', 
                key: 'tripRecords', 
                route: '/callingServiceContexts/tripRecords',
                ImageUrl: '',
            },
            { 
                title: '운전자', 
                ...
                key: 'drivers', 
                route: '/driverServiceContexts/drivers',
                ImageUrl: '',
            },
            { 
                title: '고객', 
                ...
                key: 'customers', 
                route: '/customerServiceContexts/customers',
                ImageUrl: '',
            },
